...
driver = webdriver.Chrome('/Users/KIM-JH/Desktop/jiho2/chromedriver')
...
# 데이터베이스 만들기
DATABASE_PATH = os.path.join(os.getcwd(), 'scrape_data_jh_2.db')
...
for cate_name, cate_id in list(category_id.items())[12:14]:
    # 카테고리 클릭
