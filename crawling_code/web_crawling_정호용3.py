...
driver = webdriver.Chrome('/Users/KIM-JH/Desktop/jiho3/chromedriver')
...
# 데이터베이스 만들기
DATABASE_PATH = os.path.join(os.getcwd(), 'scrape_data_jh_3.db')
...
for cate_name, cate_id in list(category_id.items())[14:16]:
    # 카테고리 클릭
