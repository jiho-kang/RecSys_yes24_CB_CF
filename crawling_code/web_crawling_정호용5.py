...
driver = webdriver.Chrome('/Users/KIM-JH/Desktop/jiho5/chromedriver')
...
# 데이터베이스 만들기
DATABASE_PATH = os.path.join(os.getcwd(), 'scrape_data_jh_5.db')
...
for cate_name, cate_id in list(category_id.items())[18:20]:
    # 카테고리 클릭
